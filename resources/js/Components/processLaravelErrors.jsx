...
function getFirstErrorMessage(responseObject) {
    ...
    if (responseObject && responseObject.error && typeof responseObject.error === 'object' && Object.keys(responseObject.error).length > 0) {
        ...
        if (Array.isArray(responseObject.error[firstKey]) && responseObject.error[firstKey].length > 0) {
