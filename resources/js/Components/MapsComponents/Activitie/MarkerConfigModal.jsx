...
const MarkerConfigModal = ({ show, onHide,onSave, onUpdate, editedMarker}) => {
  ...
  const [selectedUnidade, setSelectedUnidade] = useState(editedMarker ? editedMarker.unidade || '' : '');
          ...
          <Form.Group controlId="formUnidade">
            ...
            <Dropdown>
              <Dropdown.Toggle variant="success" id="dropdown-unidade">
                {selectedUnidade ? selectedUnidade : 'Selecione a unidade'}
              </Dropdown.Toggle>

              <Dropdown.Menu>
                <Dropdown.Item onClick={() => setSelectedUnidade('Torre')}>
                  Torre
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setSelectedUnidade('Km')}>
                  Km
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
